...
boton.addEventListener('click', function(){
    ...
    let user_id=document.getElementById('id');//Conseguir el identificador de usuario
    console.log(url+'/user/'+user_id);
    fetch(url+'/user/'+user_id, {//Metodo de llamada de la peticion Get
        method: 'GET',
    })
